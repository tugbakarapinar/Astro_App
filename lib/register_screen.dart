              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 10),
                    _buildField("Şifre", "Şifrenizi girin",
                        obscure: true, onChanged: checkPassword),
                    Column(
                    ...
                    _buildField("Şifre Tekrarı", "Şifrenizi tekrar girin",
                        obscure: true, onChanged: (val) => confirmPassword = val),
                    const SizedBox(height: 10),
                    Align(
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          validator: (value) => value == null || value.isEmpty ? 'Bu alan zorunlu' : null,
          onChanged: onChanged,
        ),
      ],
    );
